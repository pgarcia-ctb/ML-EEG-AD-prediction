"""
Title: Prediction of New Data Using Pre-Trained XGBoost Model

Author: Pablo García-Peña
Date: April 08, 2025

Description:
This script loads a pre-trained XGBoost model, scales new data,
makes predictions, and stores the results. It is designed for use in predictive analytics,
particularly in scenarios where XGBoost models are used to classify data into predefined categories
...
# Load the pre-trained best XGBoost model
model = joblib.load('best_xgb_model.pkl')  # Change the model file to the XGBoost model
scaler = joblib.load('xgb_scaler.pkl')  # Change the scaler file to the one used for XGBoost
